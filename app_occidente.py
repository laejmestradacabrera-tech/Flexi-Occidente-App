...
# --- 2. ESTILO BLINDADO (Círculo, Encabezados Rojos y Alineación) ---
st.markdown("""
    <style>
    .main-title {
    ...
    td { text-align: center !important; font-size: 15px !important; padding: 10px !important; }
...
with tab2:
    if archivo_modelos:
        ...
        # Estructura de 2 columnas: MODELO y PARES VENDIDOS
        ...
        st.info("ℹ️ Sube el archivo 'venta_modelos' para activar este módulo.")
